...
SPIDER_DEV_JSON = DEFAULT_DATA_ROOT/ "spider" / "dev.json"
SPIDER_DATABASES_PATH = "E:/spider/test_database/"
SPIDER_TRAIN_JSON = DEFAULT_DATA_ROOT / "spider" / "train_spider.json"
SPIDER_TRAIN_OTHER_JSON = DEFAULT_DATA_ROOT / "spider" / "train_others.json"
